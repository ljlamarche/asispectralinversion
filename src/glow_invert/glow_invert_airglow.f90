...
!------------
  ...
  integer :: iec, iq, iut
  real, parameter :: ec0 = 0!, ec1 = 510, ec2 = 2500
  real, parameter :: q0 = 0!
...
! write the brigthness files out.
  ...
  write( fout, "(A,'airglow/I4278_',I5.5,'_',I5.5,'.bin')"), trim(out_dir), idate, iut
  ...
  write( fout, "(A,'airglow/I5577_',I5.5,'_',I5.5,'.bin')"), trim(out_dir), idate, iut
  ...
  write( fout, "(A,'airglow/I6300_',I5.5,'_',I5.5,'.bin')"), trim(out_dir), idate, iut
  ...
  write( fout, "(A,'airglow/I8446_',I5.5,'_',I5.5,'.bin')"), trim(out_dir), idate, iut
  ...
  write( fout, "(A,'airglow/eta4278_',I5.5,'_',I5.5,'.bin')"), trim(out_dir), idate, iut
  ...
  write( fout, "(A,'airglow/eta5577_',I5.5,'_',I5.5,'.bin')"), trim(out_dir), idate, iut
  ...
  write( fout, "(A,'airglow/eta6300_',I5.5,'_',I5.5,'.bin')"), trim(out_dir), idate, iut
  ...
  write( fout, "(A,'airglow/eta8446_',I5.5,'_',I5.5,'.bin')"), trim(out_dir), idate, iut
  ...
  write( fout, "(A,'airglow/hall3d_',I5.5,'_',I5.5,'.bin')"), trim(out_dir), idate, iut
  ...
  write( fout, "(A,'airglow/ped3d_',I5.5,'_',I5.5,'.bin')"), trim(out_dir), idate, iut
  ...
  write( fout, "(A,'airglow/edens3d_',I5.5,'_',I5.5,'.bin')"), trim(out_dir), idate, iut
