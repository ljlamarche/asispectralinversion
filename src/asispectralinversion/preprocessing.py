...
#            plt.title('Dark patch distribution')
#            plt.show()
# 
#    
#    if plot:
...
#        plt.pcolor(im,vmin=cent-3*sig,vmax=cent+3*sig,cmap='seismic')
#        plt.colorbar()
#        plt.title('white is fitted background brightness')
#        plt.show()
#    #return cent,sig
...
def background_brightness(im, mask, background_method='patches', plot=True):
#>>>>>>> production
    ...
    if background_method=='patches':
        ...
        imvec = background_brightness_darkpatches(im, mask)
...
#=======
        ...
        imvec = background_brightness_corners(im, mask)
