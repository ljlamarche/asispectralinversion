...
def process_grouped_files(tstmps, files0428, files0558, files0630, folder, base_outdir, skymap_file=None, prep_kwarg=dict()):
    """
    Purpose:
    ...
    for i in range(len(tstmps)):
        ...
        feed_data(tstmps[i], folder, files0428[i], files0558[i], files0630[i], output_name, skymap_file=skymap_file, **prep_kwarg)
