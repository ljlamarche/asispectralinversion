...
def feed_data(dtdate, foi_0428, foi_0558, foi_0630, folder, output_file, skymap_file=None, plot=False, prep_kwarg=dict()):
    ...
    qout, e0out, minq, maxq, mine0, maxe0 = calculate_E0_Q_v2(redraydec, greenraydec, blueraydec, v, minE0 = 150, generous = True, plot=plot)
