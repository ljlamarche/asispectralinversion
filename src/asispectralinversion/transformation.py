...
def feed_data(dtdate, maglatsite, folder, foi_0428, foi_0558, foi_0630, output_file, skymap_file=None):
    ...
    redraydec, greenraydec, blueraydec, maglon_dec, maglat_dec = prepare_data(dtdate, foi_0630, foi_0558, foi_0428, skymap_file)
